const cajaCofres=document.getElementById("contenedorCofres"); 
cajaCofres.classList.add("centerX", "centerY");
...
function mostrarCofres(){
    ...
    for(let i=0; i<9; i++){
        ...
        //selecciono un índice random del array y luego lo elimino para no usar dos vecesel mismo valor
